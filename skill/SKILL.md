...
| [blind judges](policies/blind-judges.md) | Independent review is obtained under `Blind judges: two blind` or `Blind judges: five blind`, which are the modes that route it. `single` routes no policy document; its whole decision rule is in step 5 below, and issue #18 owns that reachability gap. |
