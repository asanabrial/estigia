...
",
    ...
    /// map the sixteen operations it lists, and adds that *"bindings MUST
    ...
    ///
    /// - `bindings/github.md` / `label` — the GitHub binding maps fifteen of
    ///   the sixteen and never names `label`, neither as a row nor as a
